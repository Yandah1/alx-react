...
describe("Testing the <Notifications /> Component", () => {
  ...
  it("verify that Notifications renders correctly if you don't pass the listNotifications property or if you pass an empty array", () => {
    wrapper.setProps({ displayDrawer: true });
    expect(wrapper.find("NotificationItem").first().html()).toEqual('<li data-notification-type=\"default\">No new notification for now</li>');
  ...
  it('renders at least one NotificationItem', () => {
    wrapper.setProps({ displayDrawer: true, listNotifications: [{ id: 1, type: "default", value: "New notification" }] });
